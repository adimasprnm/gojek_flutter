...
class _BerandaPageState extends State<BerandaPage> {
  ...
  Future<List<Food>> fetchFood() async {
    ...
    _goFoodFeaturedList
        .add(new Food(title: "Steak Andakar", image: "assets/food_1.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Mie Ayam Tumini", image: "assets/food_2.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Tengkleng Hohah", image: "assets/food_3.jpg"));
    _goFoodFeaturedList
        .add(new Food(title: "Warung Steak", image: "assets/food_4.jpg"));
